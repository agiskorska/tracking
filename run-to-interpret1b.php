...
try
{
  ...
  if($connect->connect_errno!=0)
  {
    ...
    for ($i=1; $i<1000; $i++) {
      $result = $connect->query("SELECT * FROM results_ass_1b WHERE row_no='$i'");
      ...
      $sql = $connect->query("SELECT student_id FROM by_topics1b WHERE student_id = '$sid'");
